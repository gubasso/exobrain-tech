# ADR-0007: The filesystem owns its own state, and no document indexes it
...
checked-in map naming a file that does not exist is the failure ADR-0006 already names — an
