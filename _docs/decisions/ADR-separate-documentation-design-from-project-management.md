# Separate documentation design from project management
...
Amended by [ADR-plan-record-is-lane-files](./ADR-plan-record-is-lane-files.md),
[ADR-the-unit-is-a-story-in-one-file](./ADR-the-unit-is-a-story-in-one-file.md),
[ADR-a-story-is-a-diff-a-spec-is-a-state](./ADR-a-story-is-a-diff-a-spec-is-a-state.md), and
[ADR-the-plan-linter-may-write-the-record](./ADR-the-plan-linter-may-write-the-record.md) — the deferred XP redesign landed, so
