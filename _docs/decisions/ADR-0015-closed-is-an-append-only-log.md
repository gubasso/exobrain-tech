# ADR-0015: Closed Is an Append-Only Log, and the Linter Warns
...
had to sort before it could scan. The rule was real and unenforced, which is the failure ADR-0006
