...
| Subject                                      | Owner                                                      |
| -------------------------------------------- | ---------------------------------------------------------- |
| Zones, and which one a document belongs in   | [AGENTS.md](../../AGENTS.md)                               |
| The spec artifact: parts, ids, and size      | [SPEC-docs-specs](../specs/SPEC-docs-specs.md)             |
| Requirement grammar and typed clauses        | [SPEC-docs-specs](../specs/SPEC-docs-specs.md)             |
...
| One fact, one home                           | [AGENTS.md](../../AGENTS.md)                               |
| Drafts, and what promotion means             | [AGENTS.md](../../AGENTS.md)                               |
| What an agent loads, and semantic names      | [AGENTS.md](../../AGENTS.md)                               |
