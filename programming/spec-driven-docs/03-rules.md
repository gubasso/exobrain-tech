...
A rule is the smallest unit this framework names, cites, and checks. It is one `### Requirement:`
block inside a spec, never a file of its own. This chapter owns the block: its grammar, its
