...
tutorial. See [documentation canon / placement](https://github.com/gubasso/spec-driven-docs/blob/v0.1.0/method/01-placement.md).
...
[documentation canon / single source of truth](https://github.com/gubasso/spec-driven-docs/blob/v0.1.0/method/00-model.md): duplicated
