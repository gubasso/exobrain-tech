...
| 5  | [Designing for LLM coding agents](./05-designing-for-llm-agents.md)  | The agent-facing delta: help as the source of truth, machine-readable output, output as a prompt, and when a protocol server earns its cost.  |
