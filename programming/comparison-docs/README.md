...
| Template | [Comparison](./TEMPLATE-comparison.md) | Start one.                                                          |

## Adopting

1. Copy [TEMPLATE-comparison.md](./TEMPLATE-comparison.md) into the project's explanation zone.
...
This shelf obeys [06 — Format](../spec-driven-docs/06-format.md). Chapters stay at or below 200 lines,
