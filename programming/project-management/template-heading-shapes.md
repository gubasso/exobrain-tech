...
per shape to choose the documents it applies to. The mechanism and reasoning are in
[08 — Lean Markdown](../docs-design/08-lean-markdown.md#gating-a-fixed-heading-shape); this file is
what to copy.
