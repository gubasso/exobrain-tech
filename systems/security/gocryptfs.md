...
[1]: https://wiki.archlinux.org/title/Gocryptfs "gocryptfs - ArchWiki"
[2]: https://www.linuxlinks.com/gocryptfs-encrypted-overlay-filesystem-go/ "gocryptfs – encrypted overlay filesystem written in Go"
[3]: https://man.archlinux.org/man/gocryptfs.1 "gocryptfs(1) - Arch manual pages"
[4]: https://maketecheasieraw.pages.dev/posts/how-to-encrypt-files-with-gocryptfs/ "How To Encrypt Files With Gocryptfs | maketecheasier"
[6]: https://man.archlinux.org/man/gocryptfs.1.raw "Arch manual pages"
[7]: https://www.baeldung.com/linux/bash-is-directory-mounted "Check if Directory Is Mounted in Bash | Baeldung on Linux"
[8]: https://stackoverflow.com/questions/9422461/check-if-directory-mounted-with-bash "linux - Check if directory mounted with bash - Stack Overflow"
[9]: https://nuetzlich.net/gocryptfs/reverse_mode_crypto/ "Reverse Mode Cryptography - gocryptfs - nuetzlich.net"
[10]: https://pkg.go.dev/github.com/derdonut/gocryptfs "gocryptfs command - github.com/derdonut/gocryptfs - Go ... - Go Packages"
[11]: https://github.com/rfjakob/gocryptfs/blob/master/README.md "gocryptfs/README.md at master · rfjakob/gocryptfs · GitHub"
[12]: https://nuetzlich.net/gocryptfs/forward_mode_crypto/ "gocryptfs Cryptography - nuetzlich.net"
[13]: https://flathub.org/apps/io.github.mhogomchungu.sirikali "Install SiriKali on Linux | Flathub"
[14]: https://mhogomchungu.github.io/sirikali/ "SiriKali works on Linux, macOS and Microsoft Windows Operating Systems"
[15]: https://nuetzlich.net/gocryptfs/ "gocryptfs - simple. secure. fast. - nuetzlich.net"
