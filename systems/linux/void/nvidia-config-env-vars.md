...
[1]: https://download.nvidia.com/XFree86/Linux-x86_64/515.65.01/README/gbm.html "Chapter 40. GBM and GBM-based Wayland Compositors - Nvidia"
[2]: https://discuss.cachyos.org/t/cant-get-gdm-to-show-wayland-session-upon-login/7671 "Can't get GDM to show Wayland session upon login"
[3]: https://forums.developer.nvidia.com/t/debian-testing-535-104-wayland-blackscreen/269668 "Debian testing +535.104+wayland--> blackscreen - Linux - NVIDIA ..."
[4]: https://github.com/elFarto/nvidia-vaapi-driver/blob/master/README.md "nvidia-vaapi-driver/README.md at master - GitHub"
[5]: https://discussion.fedoraproject.org/t/aleasto-nvidia-vaapi-driver/36182 "aleasto/nvidia-vaapi-driver - Fedora Discussion"
[6]: https://bbs.archlinux.org/viewtopic.php?id=294879 "No nvidia .so driver in /usr/lib/dri when needed to enable VA-API ..."
[7]: https://ubuntuhandbook.org/index.php/2024/01/firefox-vaapi-nvidia/ "Get Firefox VA-API Hardware Acceleration working on NVIDIA GPU"
[8]: https://github.com/hyprwm/Hyprland/issues/1878 "Nvidia update caused GBM_BACKEND=nvidia-drm to not work"
[9]: https://forums.developer.nvidia.com/t/gbm-does-not-work-with-hyprland-sway-games-have-fps-drops-below-30-every-few-mins/271268 "GBM does not work with Hyprland/Sway, games have FPS drops below 30 ..."
...
[11]: https://gist.github.com/kRHYME7/1d2574e8f3a4b7ad4059535503ce1eaa "Hyprland Environment Variables for NVIDIA and Intel Setups"
[12]: https://github.com/hyprwm/Hyprland/issues/9113 "Black screen when setting env = AQ_DRM_DEVICES,/dev/dri/card0:/dev/dri ..."
[13]: https://forums.linuxmint.com/viewtopic.php?t=423716 "[SOLVED] Firefox Video Acceleration, nvidia-vaapi-driver"
